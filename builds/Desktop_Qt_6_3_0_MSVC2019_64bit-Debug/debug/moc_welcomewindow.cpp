...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_WelcomeWindow_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_WelcomeWindow_t qt_meta_stringdata_WelcomeWindow = {
    {
QT_MOC_LITERAL(0, 13), // "WelcomeWindow"
QT_MOC_LITERAL(14, 22), // "on_newPaintBtn_clicked"
QT_MOC_LITERAL(37, 0), // ""
QT_MOC_LITERAL(38, 23) // "on_openPaintBtn_clicked"

    },
    "WelcomeWindow\0on_newPaintBtn_clicked\0"
    "\0on_openPaintBtn_clicked"
};
...
void WelcomeWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_newPaintBtn_clicked(); break;
        case 1: _t->on_openPaintBtn_clicked(); break;
        default: ;
        }
    }
    (void)_a;
...
const QMetaObject WelcomeWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_WelcomeWindow.offsetsAndSize,
